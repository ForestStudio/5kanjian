...
var JSON_URL = "http://"+window.location.host+"/index.php";
  ...
  var open_mobile = <?php echo C("open_mobile")?C("open_mobile"):1; ?>;
  if(mobilecheck()) {
    var appendUrl = "";
    if(location.href.indexOf('/error/500') < 0 && location.href.indexOf('/about') < 0){
	  if(open_mobile){ window.location.href = PREFIX_HOST + '/m/index.html';}     
    }
  }
...
<!-- <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=8D1kIOGsmbbeG9k4U3klKl77"></script> -->
    ...
    <link rel="stylesheet" href="/assets/eqShow-2.1.5.3.css?v=<?php $version = './Application/Common/Conf/ver.php'; $ver = include($version); $ver = $ver['ver'];$ver = substr($ver,-4);echo $ver; ?>"/>
    ...
    <script src="/assets/eqShow-site-2.1.5.3.js?v=<?php $version = './Application/Common/Conf/ver.php'; $ver = include($version); $ver = $ver['ver'];$ver = substr($ver,-4);echo $ver; ?>"></script>
<style>
.myGrid {
	width: 998px;
	height: 550px;
